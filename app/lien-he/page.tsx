...
export const metadata: Metadata = {
  title: "Liên hệ | Bắc Ninh Note",
  description: "Gửi phản hồi, đề nghị sửa sai hoặc báo vấn đề nội dung cho Bắc Ninh Note.",
  alternates: { canonical: "/lien-he" },
};

export default function ContactPage() {
  return <InfoPage eyebrow="PHẢN HỒI" title="Liên hệ Bắc Ninh Note" intro="Bạn có thể báo sai sót, liên kết hỏng, vấn đề bản quyền hoặc góp ý về cách một bài viết được trình bày." updatedAt="04.08.2026">
    <section><h2>Thông tin đơn vị xuất bản</h2><dl className="trust-grid"><div><dt>Ấn phẩm</dt><dd>Bắc Ninh Note</dd></div><div><dt>Người phụ trách nội dung</dt><dd>Kim</dd></div><div><dt>Khu vực hoạt động</dt><dd>Bắc Ninh, Việt Nam</dd></div><div><dt>Hình thức hoạt động</dt><dd>Ấn phẩm trực tuyến độc lập</dd></div></dl><p>Bắc Ninh Note không có văn phòng tiếp khách và không cung cấp hỗ trợ qua điện thoại. Địa chỉ nhà riêng, số điện thoại cá nhân và giấy tờ nhận dạng không được công khai chỉ để tạo cảm giác về quy mô.</p></section>

...
export default function ContactPage() {
  return <InfoPage eyebrow="PHẢN HỒI" title="Liên hệ Dabangzz" intro="Bạn có thể báo sai sót, liên kết hỏng, vấn đề bản quyền hoặc góp ý về cách một bài viết được trình bày.">
    ...
    <section><h2>Hợp tác và quảng cáo</h2><p>Tại thời điểm cập nhật trang này, Dabangzz chưa đăng liên kết tiếp thị liên kết và chưa phục vụ quảng cáo Google AdSense. Chúng tôi không nhận bài quảng cáo ngụy trang thành nội dung biên tập. Nếu quan hệ thương mại được bổ sung sau này, bài liên quan phải ghi nhãn rõ và không được can thiệp vào kết luận biên tập.</p></section>
  </InfoPage>;
}

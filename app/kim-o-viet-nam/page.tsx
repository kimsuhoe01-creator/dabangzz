...
export default function KimInVietnamPage() {
  return <main id="top">
    <header className="site-header"><div className="header-inner">
      ...
      <nav aria-label="Điều hướng chính"><Link href="/">Trang chủ</Link><Link href="/tin-viet-nam">Tin Việt Nam</Link><Link href="/chuyen-han-quoc">Chuyện Hàn Quốc</Link><Link href="/am-nhac-loi-dap">Âm nhạc</Link><Link href="/gioi-thieu">Giới thiệu</Link><Link href="/chinh-sach-bien-tap">Biên tập</Link></nav>
    ...
    <footer>
      ...
      <div className="footer-links"><Link href="/tin-viet-nam">Tin Việt Nam</Link><Link href="/chuyen-han-quoc">Chuyện Hàn Quốc</Link><Link href="/am-nhac-loi-dap">Âm nhạc Lời Đáp</Link><Link href="/gioi-thieu">Giới thiệu</Link><Link href="/chinh-sach-bien-tap">Chính sách biên tập</Link><Link href="/quyen-rieng-tu">Quyền riêng tư</Link><Link href="/lien-he">Liên hệ</Link></div>

...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const pages: MetadataRoute.Sitemap = [
    { url: base, lastModified: new Date("2026-07-20T01:35:00+07:00"), changeFrequency: "daily", priority: 1 },
    { url: `${base}/tin-viet-nam`, lastModified: new Date("2026-07-20T01:35:00+07:00"), changeFrequency: "daily", priority: 0.9 },
  ...
  return pages.concat(getPublishedPosts().map(post => ({
    ...
    priority: post.kind === "news" ? 0.8 : 0.6,
  })));
}

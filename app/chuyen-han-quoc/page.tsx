...
export default function KoreaStoriesPage() {
  return <main id="top">
    <header className="site-header"><div className="header-inner">
      ...
      <nav aria-label="Điều hướng chính"><Link href="/">Trang chủ</Link><Link href="/tin-viet-nam">Tin Việt Nam</Link><Link href="/chinh-sach-bien-tap">Biên tập</Link><Link href="/lien-he">Liên hệ</Link></nav>
    ...
    <footer>
      ...
      <div className="footer-links"><Link href="/tin-viet-nam">Tin Việt Nam</Link><Link href="/chinh-sach-bien-tap">Chính sách biên tập</Link><Link href="/quyen-rieng-tu">Quyền riêng tư</Link><Link href="/lien-he">Liên hệ</Link></div>

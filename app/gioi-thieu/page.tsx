...
export default function AboutPage() {
  return <InfoPage eyebrow="VỀ DABANGZZ" title="Một ấn phẩm nhỏ, trách nhiệm rõ ràng" intro="Dabangzz là ấn phẩm trực tuyến độc lập do Kim vận hành tại Bắc Ninh, Việt Nam. Trang phục vụ độc giả Việt bằng bài giải thích có nguồn, trải nghiệm trực tiếp và một chuyên mục riêng về đời sống Hàn Quốc.">
    ...
    <section><h2>Nguồn tài chính và tính độc lập</h2><p>Tại ngày 21/7/2026, Dabangzz chưa phục vụ Google AdSense và chưa chèn liên kết tiếp thị liên kết Shopee hoặc Lazada. Các bài trải nghiệm hiện có do tác giả tự thanh toán, trừ khi bài viết ghi rõ điều khác. Nếu quảng cáo, tài trợ hoặc liên kết nhận hoa hồng xuất hiện sau này, mối quan hệ đó sẽ được công khai gần nội dung liên quan.</p></section>

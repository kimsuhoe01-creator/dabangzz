...
export default function AboutPage() {
  return <InfoPage eyebrow="VỀ DABANGZZ" title="Một ấn phẩm nhỏ, trách nhiệm rõ ràng" intro="Dabangzz là ấn phẩm trực tuyến độc lập do Kim vận hành tại Bắc Ninh, Việt Nam. Trang phục vụ độc giả Việt bằng bài giải thích có nguồn, trải nghiệm trực tiếp, chuyện Hàn Quốc và một khu vực nghe nhạc riêng.">
    ...
    <section><h2>Dabangzz xuất bản gì?</h2><p><strong>Tin Việt Nam</strong> giải thích thông tin đang được quan tâm bằng nguồn chính thức, số liệu, mốc thời gian và hướng dẫn tự kiểm tra. <strong>Chuyện Hàn Quốc</strong> tổng hợp mô-típ từ thảo luận công khai, loại bỏ dữ liệu nhận dạng và viết mới hoàn toàn cho độc giả Việt Nam. <strong>Âm nhạc · Lời Đáp</strong> giới thiệu video thuộc kênh chính thức, cho phép nghe ngay trên trang và công khai việc dùng AI. Các loại nội dung được gắn nhãn và đặt ở khu vực riêng để người đọc không nhầm âm nhạc hoặc chuyện tổng hợp với tin tức.</p></section>

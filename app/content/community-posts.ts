...
import { posts20260729 } from "./posts-2026-07-29";
import { posts20260728 } from "./posts-2026-07-28";
import { posts20260727 } from "./posts-2026-07-27";
import { posts20260726 } from "./posts-2026-07-26";
...
const rawCommunityPosts: CommunityPost[] = [
  ...
  ...posts20260720,
  {
    ...
    sections: [
      ...
      { heading: "Bài học nằm ở ranh giới", paragraphs: ["Cuộc tranh luận không thật sự chỉ về chiếc thang máy. Nó cho thấy cách cộng đồng thương lượng giữa quyền của cá nhân và nhịp vận hành chung. Một cử chỉ tử tế vẫn cần tính đến những người không lên tiếng ở phía sau.", "Bắc Ninh Note tổng hợp mô-típ thảo luận công khai và viết lại tình huống; không sử dụng thông tin nhận dạng hay lời kể nguyên văn của bất kỳ cá nhân nào." ]}
    ]
  },
  {
